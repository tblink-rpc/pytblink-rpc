...
#include "../../../../../../ext/launcher/vpi_user.h"
...
static void printhelp() {
	...
	fprintf(stdout, "Verilated simulation image for module \"smoke_tb\"\n");
...
int main(int argc, char **argv) {
	...
	if (!vpi_iterate(vpiModule, 0)) {
		...
		prv_top->__VlSymsp->__Vhier.add(0, &prv_top->__VlSymsp->__Vscope_smoke_tb);
	}
#endif
#endif
	...
	clockspec_t			clockspec[] = {
		{.name="clock", .clk=&prv_top->clock, .period=10000, .offset=0}
